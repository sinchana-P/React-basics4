...
function Die(props) {
    ...
    return(
       ...
       // <div className= {props.isHeld ? "die-face die-num bg" : "die-face die-num"} onClick={(event) => props.held(event, props.id)} id={props.id}>{props.value}</div>
    )
}
...
function App() {
    ...
    //         {
    //             ...singleDie,
    //             isHeld: singleDie.id == id ? true : false,
    //             dieValue : singleDie.dieValue
